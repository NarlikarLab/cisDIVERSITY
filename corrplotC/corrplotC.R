...
#' @export
source("corrplotC/colorlegend.R")
source("corrplotC/colors.R")
source("corrplotC/corrMatOrder.R")
source("corrplotC/corrRect.R")
source("corrplotC/corrRect.hclust.R")

corrplotC = function(corr,
